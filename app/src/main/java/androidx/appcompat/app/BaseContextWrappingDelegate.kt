...
class BaseContextWrappingDelegate(private val superDelegate: AppCompatDelegate, private val attachBaseContextDelegate: OnAttachBaseContext) : AppCompatDelegate() {
    ...
    private fun wrap(context: Context): Context {
        return attachBaseContextDelegate.onAttachBaseContext(context)
    }
}
